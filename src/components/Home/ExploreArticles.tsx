    ...
    >
      <div className="relative w-full rounded-3xl text-[rgba(2, 27, 42, 1)] aspect-[16/9]">
        <Image
          ...
          sizes="(min-width: 1536px) 340px, (min-width: 1024px) 300px, 80vw rounded-2xl"
        />
      </div>
      ...
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto">
        ...
        >
          <div>
            ...
            <p className="mt-3 text-base md:text-xl font-bold  ">
                Design thinking, conversion wins, and growth tactics. We're sharing everything <br /> we've learned building brands that actually grow.
            </p>
          </div>
        </motion.div>
